...
/***/ function(module, exports, __webpack_require__) {
	...
	var _path = __webpack_require__(186);

	var _path2 = _interopRequireDefault(_path);

	var _bodyParser = __webpack_require__(187);

	var _bodyParser2 = _interopRequireDefault(_bodyParser);

	var _clientSessions = __webpack_require__(188);
	...
	app.get('*', function (req, res) {
		...
		(0, _reactRouter.match)({ routes: routes, location: req.url }, function (error, redirectLocation, renderProps) {
			if (error) {
				...
				res.status(200).send('<!DOCTYPE html>' + (0, _server.renderToString)(_react2.default.createElement(_reactRouter.RouterContext, renderProps)));
			} else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isTextInputElement = __webpack_require__(46);
	var keyOf = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMComponentFlags = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoFocusUtils = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dangerousStyleValue = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(31);
	var ReactDOMInstrumentation = __webpack_require__(80);
	var ReactPerf = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMDebugTool = __webpack_require__(81);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMUnknownPropertyDevtool = __webpack_require__(82);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DisabledInputUtils = __webpack_require__(88);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SigninComponent = __webpack_require__(179);

	var _SigninComponent2 = _interopRequireDefault(_SigninComponent);

	var _RadarComponent = __webpack_require__(169);

	var _RadarComponent2 = _interopRequireDefault(_RadarComponent);

	var _AdditemComponent = __webpack_require__(180);

	var _AdditemComponent2 = _interopRequireDefault(_AdditemComponent);

	var _SharedradarComponent = __webpack_require__(181);

	var _SharedradarComponent2 = _interopRequireDefault(_SharedradarComponent);
	 ...
	 */
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(_reactRouter.IndexRoute, { component: _SigninComponent2.default }),
				_react2.default.createElement(_reactRouter.Route, { path: "/radar", component: _RadarComponent2.default }),
				_react2.default.createElement(_reactRouter.Route, { path: "/additem", component: _AdditemComponent2.default })
			),
			_react2.default.createElement(_reactRouter.Route, { path: "/radar/:id", component: _SharedradarComponent2.default })
		);
	};
	...
	var MainComponent = function (_React$Component) {
		...
		_createClass(MainComponent, [{
			...
			value: function componentDidMount() {
				...
				_Store2.default.subscribe(function () {
					...
					_this2.setState({
						...
						if (_this2.state.user) {
							if (_this2.props.location.pathname.length > 1) {
								_reactRouter.browserHistory.push(_this2.props.location.pathname);
							} else {
								_reactRouter.browserHistory.push('/radar');
							}
						} else {
				...
				_Store2.default.dispatch((0, _actions.validateUser)());
			}
		}, {
			key: "render",
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement("link", { rel: "stylesheet", type: "text/css", href: "https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" })
						),
						_react2.default.createElement(
							"body",
							null,
							...
							_react2.default.createElement("script", { type: "text/javascript", src: "js/app.js" })
						)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopbarComponent = function (_React$Component) {
		_inherits(TopbarComponent, _React$Component);

		function TopbarComponent() {
			_classCallCheck(this, TopbarComponent);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(TopbarComponent).call(this));
		}
		...
		_createClass(TopbarComponent, [{
			...
			value: function render() {
				...
				var share = id ? _react2.default.createElement('a', { target: '_blank', href: "./radar/" + id, className: 'sharelink ion-share' }) : "";
	...
	TopbarComponent = (0, _reactRedux.connect)(function (state) {
		return state;
	})(TopbarComponent);
...
/***/ function(module, exports) {
	...
	exports.addToRadar = addToRadar;
	exports.getUserRadar = getUserRadar;
	exports.deleteFromRadar = deleteFromRadar;
	exports.registerUser = registerUser;
	exports.signIn = signIn;
	exports.validateUser = validateUser;
	var REQUEST_REPOS = exports.REQUEST_REPOS = 'REQUEST_REPOS';
	...
	function fetchPosts(obj) {
		return function (dispatch) {
			...
			return fetch('https://api.github.com/search/repositories?q=' + obj.query + '+language:' + obj.language + '&sort=stars&order=desc').then(function (response) {
				return response.json();
			}).then(function (json) {
				return dispatch(receiveRepos(obj, json));
			}).catch(function (err) {
				console.log(err);
			});
		};
	...
	var RECEIVE_RADAR = exports.RECEIVE_RADAR = 'RECEIVE_RADAR';
	...
	var FETCH_RADAR = exports.FETCH_RADAR = 'FETCH_RADAR';
	...
	function addToRadar(radarType, obj) {
		return function (dispatch) {
			...
			var data = 'repoName=' + obj.name + '&radarType=' + radarType + '&description=' + obj.description;
			xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
			xhr.send(data);
		};
	}

	function getUserRadar(id) {
		return function (dispatch) {
			var xhr = new XMLHttpRequest();
	...
	function registerUser(data) {
		return function (dispatch) {
			...
			xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
			var d = 'email=' + data.email + '&password=' + data.password;
			xhr.send(d);
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ResultComponent = __webpack_require__(170);

	var _ResultComponent2 = _interopRequireDefault(_ResultComponent);

	var _TechitemsComponent = __webpack_require__(176);

	var _TechitemsComponent2 = _interopRequireDefault(_TechitemsComponent);
	...
	var RadarComponent = function (_React$Component) {
		_inherits(RadarComponent, _React$Component);

		function RadarComponent(props) {
			_classCallCheck(this, RadarComponent);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(RadarComponent).call(this, props));

			_this.displayName = "RadarComponent";
			return _this;
		}

		_createClass(RadarComponent, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
			...
			value: function render() {
				...
				items.forEach(function (obj, i) {
					if (i < 8) {
						results.push(_react2.default.createElement(_ResultComponent2.default, { key: obj.id, obj: obj }));
					}
				});
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								_reactRouter.Link,
								{ className: 'tab-item', to: '/radar' },
								'Search Github'
							),
							_react2.default.createElement(
								_reactRouter.Link,
								{ className: 'tab-item', to: '/additem' },
								'Add your own'
							)
						),
						_react2.default.createElement('input', { type: 'text', placeholder: 'Search Github', className: 'search', onKeyPress: this.searchGithub.bind(this) }),
						_react2.default.createElement(
							'div',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'c _1 selected' },
								_react2.default.createElement(_TechitemsComponent2.default, { type: 'hold', user: this.props.user.user }),
								_react2.default.createElement(
									'div',
									{ className: 'c _2' },
									_react2.default.createElement(_TechitemsComponent2.default, { type: 'assess', user: this.props.user.user }),
									_react2.default.createElement(
										'div',
										{ className: 'c _3' },
										_react2.default.createElement(_TechitemsComponent2.default, { type: 'trial', user: this.props.user.user }),
										_react2.default.createElement(
											'div',
											{ className: 'c _4' },
											_react2.default.createElement(_TechitemsComponent2.default, { type: 'adopt', user: this.props.user.user })
										)
									)
								)
							)
	...
	RadarComponent = (0, _reactRedux.connect)(function (state) {
		return state;
	})(RadarComponent);
	exports.default = RadarComponent;
	...
	var RadarComponent = function (_React$Component) {
		...
		_createClass(RadarComponent, [{
			...
			value: function menuClick(e) {
				...
				_Store2.default.dispatch((0, _actions.addToRadar)(action, this.props.obj));
			}
		}, {
			key: 'render',
			value: function render() {
				...
				if (this.state.toggleMenu) {
					menu = _react2.default.createElement(
						...
						_react2.default.createElement(
							'li',
							{ onClick: this.menuClick.bind(this), 'data-action': 'hold' },
							'Hold'
						),
						_react2.default.createElement(
							'li',
							{ onClick: this.menuClick.bind(this), 'data-action': 'assess' },
							'Assess'
						),
						_react2.default.createElement(
							'li',
							{ onClick: this.menuClick.bind(this), 'data-action': 'trial' },
							'Trial'
						),
						_react2.default.createElement(
							'li',
							{ onClick: this.menuClick.bind(this), 'data-action': 'adopt' },
							'Adopt'
						)
					);
				}
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'avatar' },
						_react2.default.createElement('img', { src: this.props.obj.owner.avatar_url, width: '40' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'name' },
					...
					_react2.default.createElement(
						'div',
						{ className: 'ion-drag', onClick: this.toggleMenu.bind(this) },
						menu
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TechitemComponent = function (_React$Component) {
	  _inherits(TechitemComponent, _React$Component);

	  function TechitemComponent(props) {
	    _classCallCheck(this, TechitemComponent);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TechitemComponent).call(this, props));

	    _this.displayName = 'TechitemComponent';

	    var items = _this.getTechItems(_this.props.type);
	    _this.state = {
	      items: items || [],
	      current: null
	    };
	  ...
	  _createClass(TechitemComponent, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {}
	  }, {
	    key: 'componentDidUpdate',
	    value: function componentDidUpdate(prevProps, prevState) {
	      if (prevProps.user !== this.props.user) {
	        var items = this.getTechItems(this.props.type);
	        this.setState({
	          items: items
	        });
	      }
	    ...
	    key: 'getTechItems',
	    value: function getTechItems(type) {
	      var techitems = [];
	      if (this.props.user && this.props.user.techitems) {
	        this.props.user.techitems.forEach(function (obj, i) {
	    ...
	    value: function deleteItem(e) {
	      var conf = confirm('Delete this?');
	      if (conf) {
	        var id = e.target.parentNode.getAttribute('data-id');
	        this.props.dispatch((0, _actions.deleteFromRadar)(id));
	      }
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      if (this.state.current) {
	        lightbox = _react2.default.createElement(
	          'div',
	          { className: 'lightbox' },
	          _react2.default.createElement('div', { className: 'close ion-close', onClick: this.closeLightbox.bind(this) }),
	          _react2.default.createElement(
	            'div',
	            { className: 'title' },
	      ...
	      return _react2.default.createElement(
	        ...
	        this.state.items.map(function (obj, i) {
	          return _react2.default.createElement(
	            'div',
	            { key: i, className: 'techitem', 'data-id': obj._id, 'data-index': i, onClick: _this2.lightbox.bind(_this2) },
	            obj.name,
	            _react2.default.createElement('div', { className: 'close ion-close', onClick: _this2.deleteItem.bind(_this2) })
	          );
	        }),
	        lightbox
	      );
	  ...
	  return TechitemComponent;
	}(_react2.default.Component);

	TechitemComponent = (0, _reactRedux.connect)()(TechitemComponent);
	exports.default = TechitemComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SigninComponent = function (_React$Component) {
		...
		function SigninComponent(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(SigninComponent).call(this, props));
		}
		...
		_createClass(SigninComponent, [{
			...
			value: function register(e) {
				...
				if (data.email !== data.emailConfirm) {
					...
					this.props.dispatch((0, _actions.registerUser)(data));
				}
			}
		}, {
			key: 'signIn',
			value: function signIn(e) {
				...
				this.props.dispatch((0, _actions.signIn)(data));
			}
		}, {
			key: 'render',
			value: function render() {
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement('input', { type: 'text', name: 'signin_email', placeholder: 'E-mail' })
									)
								),
								_react2.default.createElement(
									'div',
									...
									_react2.default.createElement(
										'div',
										{ className: 'medium-12 columns' },
										_react2.default.createElement('input', { type: 'password', name: 'signin_password', placeholder: 'Password' })
									)
								),
								_react2.default.createElement(
									'div',
									...
									_react2.default.createElement(
										'div',
										{ className: 'medium-12 columns' },
										_react2.default.createElement('input', { type: 'submit', value: 'Sign in', className: 'button', onClick: this.signIn.bind(this) })
									)
								)
							)
						),
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'div',
										{ className: 'medium-12 columns' },
										_react2.default.createElement('input', { type: 'text', name: 'register_email', placeholder: 'E-mail' })
									),
									_react2.default.createElement(
										'div',
										{ className: 'medium-12 columns' },
										_react2.default.createElement('input', { type: 'text', name: 'register_email_confirm', placeholder: 'Retype e-mail' })
									)
								),
								_react2.default.createElement(
									'div',
									...
									_react2.default.createElement(
										'div',
										{ className: 'medium-12 columns' },
										_react2.default.createElement('input', { type: 'password', name: 'register_password', placeholder: 'Password' })
									)
								),
								_react2.default.createElement(
									'div',
									...
									_react2.default.createElement(
										'div',
										{ className: 'medium-12 columns' },
										_react2.default.createElement('input', { type: 'submit', value: 'Register', className: 'button', onClick: this.register.bind(this) })
									)
								)
							)
						),
	...
	SigninComponent = (0, _reactRedux.connect)()(SigninComponent);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdditemComponent = function (_React$Component) {
		_inherits(AdditemComponent, _React$Component);

		function AdditemComponent(props) {
			_classCallCheck(this, AdditemComponent);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AdditemComponent).call(this, props));

			_this.displayName = "AdditemComponent";
			return _this;
		}
		...
		_createClass(AdditemComponent, [{
			...
			value: function addToRadar(e) {
				...
				this.props.dispatch((0, _actions.addToRadar)(action, {
					name: name,
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'form',
							{ id: 'additem' },
							_react2.default.createElement('input', { type: 'text', name: 'name', placeholder: 'Title' }),
							_react2.default.createElement(
								'select',
								{ name: 'actions' },
								_react2.default.createElement(
							...
							_react2.default.createElement('textarea', { placeholder: 'Description', name: 'description' }),
							_react2.default.createElement('input', { type: 'submit', value: 'Add to radar', className: 'button', onClick: this.addToRadar.bind(this) })
						)
					),
					_react2.default.createElement(
						'div',
	...
	AdditemComponent = (0, _reactRedux.connect)(function (state) {
		return state;
	})(AdditemComponent);
	exports.default = AdditemComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SharedradarComponent = function (_React$Component) {
		_inherits(SharedradarComponent, _React$Component);

		function SharedradarComponent() {
			_classCallCheck(this, SharedradarComponent);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(SharedradarComponent).apply(this, arguments));
		}

		_createClass(SharedradarComponent, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				console.log(this.props);
				var id = this.props.params.id;
				_Store2.default.dispatch((0, _actions.getUserRadar)(id));
			}
		}, {
			key: 'render',
			value: function render() {
		...
		return SharedradarComponent;
	}(_react2.default.Component);

	exports.default = SharedradarComponent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var validateUser = function validateUser(req) {
		return new Promise(function (resolve) {
			if (req.sXtechCookie && req.sXtechCookie.user) {
				_db2.default.getUser(req.sXtechCookie.user._id).then(function (user) {
					resolve(user);
				});
			} else {
				resolve(null);
	...
	router.get('/radar/:id', function (req, res) {
		var id = req.params.id;

		_db2.default.getUserRader(id).then(function (radar) {
			res.json(radar);
		});
	});

	router.delete('/radar/:id', function (req, res) {
		var u = validateUser(req);
		u.then(function (user) {
			if (user) {
				_db2.default.removeItem(user.id, req.params.id).then(function (data) {
					res.json(data);
				});
			} else {
				res.json(null);
	...
	router.post('/register', function (req, res) {
		...
		_db2.default.createUser(email, password).then(function (user) {
			if (user._id) {
	...
	router.post('/signin', function (req, res) {
		...
		_db2.default.signInUser(email, password).then(function (user) {
			if (user) {
				req.sXtechCookie.user = user;
				res.json(user);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mongoose = __webpack_require__(184);

	var _mongoose2 = _interopRequireDefault(_mongoose);

	var _bcryptNodejs = __webpack_require__(185);

	var _bcryptNodejs2 = _interopRequireDefault(_bcryptNodejs);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_mongoose2.default.connect('mongodb://localhost/techradar');

	var Schema = _mongoose2.default.Schema;

	var User = _mongoose2.default.model('User', { email: { type: String, unique: true }, password: String, techitems: Array });
	var Techitem = _mongoose2.default.model('Techitem', { name: String, radarType: String, description: String });

	var _getUser = function _getUser(id) {
		return new Promise(function (resolve, reject) {
			User.findOne({ _id: id }, { email: 1, techitems: 1 }, function (err, res) {
				if (err) reject(err);
	...
	var methods = {
		createUser: function createUser(email, password) {
			return new Promise(function (resolve) {
				var u = new User({ email: email, password: _bcryptNodejs2.default.hashSync(password) });
				u.save(function (err, p) {
		...
		signInUser: function signInUser(email, password) {
			return new Promise(function (resolve, reject) {
				User.findOne({ email: email }, { email: 1, password: 1 }, function (err, res) {
					if (err) {
						reject(err);
					}
					if (res && _bcryptNodejs2.default.compareSync(password, res.password)) {
						_getUser(res._id).then(function (user) {
							resolve(user);
						});
					} else {
						resolve(null);
		...
		getUser: function getUser(id) {
			return new Promise(function (resolve) {
				_getUser(id).then(function (user) {
					resolve(user);
				});
			});
		},

		getUserRader: function getUserRader(id) {
			return new Promise(function (resolve) {
				_getUser(id).then(function (user) {
					user.email = null;
					resolve(user);
		...
		addItem: function addItem(id, techitem) {
			return new Promise(function (resolve, reject) {
				var ti = new Techitem(techitem);
		...
		removeItem: function removeItem(userid, itemid) {
			console.log(userid, _mongoose2.default.Types.ObjectId(itemid));
			return new Promise(function (resolve, reject) {

				User.update({ _id: userid }, { $pull: { techitems: { _id: _mongoose2.default.Types.ObjectId(itemid) } } }, function (err, data) {
					if (err) reject(err);
					_getUser(userid).then(function (user) {
						resolve(user);
					});
				});
			});
